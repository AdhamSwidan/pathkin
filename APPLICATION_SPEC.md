...
- **حقول المغامرة:**
    ...
    - **الإحداثيات (Coordinates):** يتم حفظها تلقائيًا عند اختيار موقع من الاقتراحات.
...
### 2.7. عرض الخريطة
- تستخدم Google Maps Platform لعرض خريطة تفاعلية.
- تعرض بشكل افتراضي جميع المغامرات من نوع "فعالية" التي لها إحداثيات.
- النقر على أيقونة الموقع في بطاقة المغامرة ينقل المستخدم إلى الخريطة مع التركيز على موقع تلك المغامرة.
...
- **تصميم مركزي (Centered Layout):** على الشاشات الكبيرة، يتم عرض المحتوى الرئيسي في منتصف الشاشة بعرض محدد (max-width)، مما يحسن من قابلية القراءة والمظهر العام ويحاكي تصميم المنصات الاجتماعية الكبرى.
- (تبقى المواصفات الأخرى كما هي)
