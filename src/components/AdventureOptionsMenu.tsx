...
interface AdventureOptionsMenuProps {
...
const AdventureOptionsMenu: React.FC<AdventureOptionsMenuProps> = ({ adventure, onClose, onEdit, onDelete }) => {
...
export default AdventureOptionsMenu;
