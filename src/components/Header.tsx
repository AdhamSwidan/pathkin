...
const Header: React.FC<HeaderProps> = ({ title, onBack, rightAction }) => {
  return (
    <div className="relative sticky top-0 z-40 bg-light-bg-secondary/70 dark:bg-dark-bg-secondary/70 backdrop-blur-lg border-b border-slate-200/60 dark:border-zinc-800/60 h-14 flex items-center justify-center w-full">
      {onBack && (
