...
interface PostCardProps {
  ...
  onMessageClick?: (user: User) => void; // Made optional to fix build error
...
const PostCard: React.FC<PostCardProps> = ({ 
  ...
  const isOwnPost = currentUser ? post.author.id === currentUser.id : false;
    ...
    <div className="bg-white dark:bg-neutral-900 border border-gray-200 dark:border-neutral-800 rounded-lg shadow-sm mb-4">
      <div className="p-4">
        ...
        <div className="flex items-center justify-between mb-3">
            ...
            {!isOwnPost && !isGuest && onMessageClick && (
                <button
                    onClick={(e) => {
                        e.stopPropagation();
                        onMessageClick(post.author);
                    }}
                    className={`p-2 rounded-full flex-shrink-0 ms-2 text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-neutral-800`}
