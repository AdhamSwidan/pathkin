    ...
    <div className="bg-white dark:bg-neutral-900 border border-gray-200 dark:border-neutral-800 rounded-lg shadow-sm mb-4">
      <div className="p-4">
        ...
        <div className="flex items-center justify-between mb-3">
          ...
          {!isOwnPost && (
            <button
              onClick={() => onMessageClick(post.author)}
              disabled={isGuest}
              className={`p-2 rounded-full flex-shrink-0 ${isGuest ? disabledClasses : 'text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-neutral-800'}`}
